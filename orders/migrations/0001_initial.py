    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transportation_mode', models.CharField(choices=[('bicycle', 'Bicycle'), ('keke_napep', 'Keke Napep (Tricycle)')], default='bicycle', max_length=20, verbose_name='Transportation Mode')),
                ('subtotal', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Subtotal')),
                ('delivery_cost', models.DecimalField(decimal_places=2, default=100.0, max_digits=10, verbose_name='Delivery Cost')),
                ...
                ('delivery_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='orders.deliveryaddress', verbose_name='Delivery Location')),
            ],
        ),
        migrations.CreateModel(
            name='DeliveryLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', models.CharField(max_length=15)),
                ('profile_image', cloudinary.models.CloudinaryField(blank=True, help_text='Optional profile picture', max_length=255, null=True, verbose_name='image')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
